<?php namespace Atlantis\Core\Client\Javascript;

use Exception;
use Atlantis\Core\View\Binder;
...
class Provider {
     ...
     */
    function __construct(Binder $viewBinder, $namespace = 'window')
    {
